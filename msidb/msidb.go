...
var (
	schemaTables = []Column{
		{Name: "Name", Type: ColumnString, Size: 64, PrimaryKey: true}, //nolint:goconst
	}
	schemaColumns = []Column{
		{Name: "Table", Type: ColumnString, Size: 64, PrimaryKey: true},
		{Name: "Number", Type: ColumnInteger, Size: 2, PrimaryKey: true},
		{Name: "Name", Type: ColumnString, Size: 64},
		{Name: "Type", Type: ColumnInteger, Size: 2},
	}
	schemaStreams = []Column{
		{Name: "Name", Type: ColumnString, Size: 62, PrimaryKey: true},
